...
import type { HotListSource, NeteaseResponse, QqNewsResponse } from './hot-list.types';
import { compactHot, normalizeTimestamp, withRanks } from './hot-list.utils';
import { defineDirectSource } from './source-factory';

export const REFERENCE_DIRECT_HOT_LIST_SOURCES: readonly HotListSource[] = [
  defineDirectSource({
    id: 'dongchedi',
    async fetch(signal) {
