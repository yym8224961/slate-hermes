...
export async function createGroupScriptServices(): Promise<GroupScriptServices> {
  ...
  const [
    ...
    import('../../src/modules/contents/contents-read.service'),
    import('../../src/modules/contents/contents.service'),
    import('../../src/modules/dynamic-content/dynamic-content.service'),
  ]);
  ...
  return {
    ...
    contentReads: app.get(ContentsReadService),
    dynamicContent: app.get(DynamicContentService),
  };
}
