...
const ZFULL_GB_NOTE = '按 Zfull-GB 点阵生成，覆盖 ASCII、GB2312 常用汉字和常用符号。';
...
export const FONT_TEST_FONTS = [
  ...
  },
  {
    id: 'zfull_gb_10',
    label: 'Zfull-GB 10',
    file: 'zfull-gb-10.json',
    sizePx: 10,
    kind: 'cjk',
    hint: '10px GB2312',
    note: ZFULL_GB_NOTE,
    source: 'zfull-for-yosemite',
    license: 'No explicit license',
  },
  {
    id: 'zfull_gb_12',
    label: 'Zfull-GB 12',
    file: 'zfull-gb-12.json',
    sizePx: 12,
    kind: 'cjk',
    hint: '12px GB2312',
    note: ZFULL_GB_NOTE,
