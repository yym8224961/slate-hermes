// 动态内容类型选择 grid。0 圆角 ink 边框，hover 反相。

import { Calendar, CalendarDays, CloudSun, BookText, BarChart3, Type } from 'lucide-react';
...
const ITEMS: Item[] = [
  { type: 'daily_calendar', title: '日历', hint: '每日一页 · 农历 · 节气', Icon: Calendar },
  { type: 'month_calendar', title: '月历', hint: '整月视图 · 节日 · 高亮今日', Icon: CalendarDays },
  ...
  { type: 'font_test', title: '字体测试', hint: '切换字体，查看 1bpp 渲染', Icon: Type },
];
