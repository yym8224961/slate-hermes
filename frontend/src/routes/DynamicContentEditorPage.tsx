...
//
// 路由：
//   /groups/:gid/contents/dynamic/new             — 创建
//   /groups/:gid/contents/dynamic/:contentId/edit — 编辑

import { useParams, useNavigate } from 'react-router-dom';
import { useDynamicConfig, useGroupContents } from '../lib/queries';
import { DynamicContentEditor } from '../components/DynamicContentEditor';
